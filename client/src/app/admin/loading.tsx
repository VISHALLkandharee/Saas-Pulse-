    ...
    <div className="min-h-[80vh] flex flex-col items-center justify-center p-8 text-center space-y-6">
      <div className="relative">
        ...
        <div className="w-16 h-16 bg-zinc-900 border border-zinc-800 rounded-full flex items-center justify-center relative shadow-2xl">
          <Shield className="text-purple-500 animate-bounce" size={32} />
        </div>
      </div>
      
      <div className="space-y-2 animate-pulse">
        <h3 className="text-lg font-bold tracking-tight text-white">Loading Founder Hub...</h3>
      ...
      <div className="w-48 h-1 bg-zinc-900 rounded-full overflow-hidden">
        <div className="h-full bg-purple-500 w-1/3 rounded-full animate-[pulse_1.5s_ease-in-out_infinite] shadow-[0_0_10px_rgba(168,85,247,0.5)]" />
      </div>
    </div>
  );
}
